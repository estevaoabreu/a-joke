...
function setup() {
  ...
  for (let i = 0; i < creditos.length; i++) {
    creditos_x[i] = random(textWidth(creditos[i]), width - textWidth(creditos[i])*2);
    creditos_y[i] = -50;
    creditos_vel[i] = 0.1;
  }
...
function draw() {
  if (!comecar) {
    ...
    muteInterval = int(map(sliders[2].value, 0, 1, 30, 0));
...
function legendar() {
  if (narracao.currentTime() < 0) {
    texto = "";
  }
  else if (narracao.currentTime() < 20) {
  ...
  } else if (narracao.currentTime() < 40) {
  ...
  } else if (narracao.currentTime() < 60 * 1 + 5) {
  ...
  } else if (narracao.currentTime() < 60 * 1 + 24) {
  ...
  } else if (narracao.currentTime() < 60 * 1 + 46) {
  ...
  } else if (narracao.currentTime() < 60 * 2 + 5) {
  ...
  } else if (narracao.currentTime() < 60 * 2 + 22) {
  ...
  else if (narracao.currentTime() < 60 * 3 + 13) {
  ...
  else if (narracao.currentTime() < 60 * 3 + 40) {
  ...
  else if (narracao.currentTime() < 60 * 4 + 16) {
  ...
  else if (narracao.currentTime() < 60 * 4 + 53) {
  ...
  else if (narracao.currentTime() < 60 * 5 + 22) {
  ...
  else if (narracao.currentTime() < 60 * 5 + 42) {
  ...
  else if (narracao.currentTime() < 60 * 6 + 14) {
  ...
  else if (narracao.currentTime() < 60 * 6 + 47) {
  ...
  } else if (narracao.currentTime() < 60 * 7 + 9) {
  ...
  } else if (narracao.currentTime() < 60 * 7 + 31) {
  ...
  } else if (narracao.currentTime() < 60 * 7 + 59) {
  ...
  else if (narracao.currentTime() < 60 * 8 + 33) {
  ...
  else if (narracao.currentTime() < 60 * 8 + 59) {
  ...
  else if (narracao.currentTime() < 60 * 9 + 21) {
  ...
  else if (narracao.currentTime() < 60 * 9 + 51) {
  ...
  else if (narracao.currentTime() < 60 * 10 + 18) {
  ...
  else if (narracao.currentTime() < 60 * 10 + 45) {
  ...
  else if (narracao.currentTime() < 60 * 11 + 6) {
  ...
  else if (narracao.currentTime() < 60 * 11 + 23) {
  ...
  else if (narracao.currentTime() < 60 * 11 + 37) {
  ...
  else if (narracao.currentTime() < 60 * 11 + 58) {
  ...
  else if (narracao.currentTime() < 60 * 12 + 14) {
  ...
  else if (narracao.currentTime() < 60 * 12 + 37) {
  ...
  else if (narracao.currentTime() < 60 * 13 + 6) {
  ...
  else if (narracao.currentTime() < 60 * 13 + 29) {
  ...
  else if (narracao.currentTime() < 60 * 13 + 49) {
